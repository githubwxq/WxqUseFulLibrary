...
import com.example.wxq.wxqusefullibrary.model.NestBean;
import com.example.wxq.wxqusefullibrary.model.TestBean;
import com.example.wxq.wxqutilslibrary.activity.BaseActivity;

import java.util.ArrayList;
import java.util.List;

import linearlayoutlistview.NestFullListView;
import linearlayoutlistview.NestFullListViewAdapter;
import linearlayoutlistview.NestFullViewHolder;

public class LinearLayoutAdapterActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linear_layout_adapter);
        initDatas();
        ...
        nestFullListView.setAdapter(new NestFullListViewAdapter<TestBean>(R.layout.item_lv, mDatas) {
            ...
            public void onBind(int pos, TestBean testBean, NestFullViewHolder holder) {
                ...
                Glide.with(LinearLayoutAdapterActivity.this)
