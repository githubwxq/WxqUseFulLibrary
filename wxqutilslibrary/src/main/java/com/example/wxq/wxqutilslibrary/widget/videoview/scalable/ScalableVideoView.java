package com.example.wxq.wxqutilslibrary.widget.videoview.scalable;
...
//mVideoView.setDataSource("/storage/emulated/0/LuPingDaShi/Rec/2016-11-05_23_12_10.mp4");
...
//        mp.stop();
//        Toast.makeText(MainActivity.this,"wxqwx",Toast.LENGTH_LONG).show();
//        }
//        });
//mVideoView.setScalableType(scalableType);
//        mVideoView.invalidate();
//
//        video_view_2.setRawData(R.raw.portrait_sample);
//        video_view_2.setVolume(0, 0);
//        video_view_2.setLooping(true);
//        video_view_2.prepare(new MediaPlayer.OnPreparedListener() {
//@Override
//public void onPrepared(MediaPlayer mp) {
//        video_view_2.start();
//        }
