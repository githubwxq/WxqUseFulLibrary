...
import swipemenu.interfaces.onSwipeProgressListener;
import swipemenu.util.BlurUtil;
import swipemenu.util.SizeUtil;
...
public class SwipeMenu extends ViewGroup {
    ...
    public void setStyleCode(int type) {
        try {
            ...
            mTransInt = ints[0] - '0';//字符相互减去12111 缩放
            mScaleInt = ints[1] - '0';
            mAlphaInt = ints[2] - '0';
            mRotateInt = ints[3] - '0';
    ...
    private void initObtainStyledAttr(Context context, AttributeSet attrs) {
        ...
        mDragWipeOffset = (int) array.getDimension(R.styleable.SwipeMenu_sm_dragoffset, SizeUtil.Dp2Px(context, 20));
