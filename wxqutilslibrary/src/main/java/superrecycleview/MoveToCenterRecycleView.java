 ...
 * 点击item自动居中的横向的recycleview
 */
public class MoveToCenterRecycleView extends RecyclerView {
    private static final String TAG = MoveToCenterRecycleView.class.getSimpleName();
    ...
    public MoveToCenterRecycleView(Context context) {
        super(context);
        init(context);
    }

    public MoveToCenterRecycleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MoveToCenterRecycleView(Context context, AttributeSet attrs, int defStyle) {
