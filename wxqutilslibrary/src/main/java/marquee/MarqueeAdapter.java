...
public abstract class MarqueeAdapter<T extends View, E> {
    ...
    public abstract T generateMarqueeItemView(E data);  // 数据转view
    ...
    public void setData(List<E> datas) {
        ...
        for (int i = 0; i < datas.size(); i++) {
            ...
            mView.setTag(new ViewHolder(mView, data, i));// 点击的时候数据 位子 控件都回调出去
        ...
        if (mMarqueeView != null) {
            mMarqueeView.setMarqueeFactory(this);  // 获取数据后将适配器对象给viewgroup
